...
const SCRI_MAIN_STEPS: CopilotStep[] = [
  { id: "cards", title: "Ringkasan SCRI-36", desc: "Tiga kartu akses cepat ke sub-halaman: lihat & kelola Pertanyaan, atur Penilaian, dan buka halaman Hasil pengisian." },
  { id: "dimensions", title: "Pertanyaan per Dimensi", desc: "Lihat berapa pertanyaan yang sudah ada per dimensi. Klik baris dimensi untuk membuka daftar pertanyaan yang sudah difilter ke dimensi tersebut." },
...
export default function AdminScriPage() {
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <AdminCopilot
        pageTitle="SCRI-36 Management"
        steps={SCRI_MAIN_STEPS}
        youtubeUrl={ADMIN_TUTORIALS.scri}
        storageKey="scri"
      />
